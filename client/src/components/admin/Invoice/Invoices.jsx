...
const CSV_COLUMNS = [
  ...
  { key: "ConsignorAddress", label: "Consignor Address" },
  { key: "ConsignorSiteId", label: "Consignor Site ID" },
  { key: "Consignee", label: "Consignee" },
  { key: "ConsigneeAddress", label: "Consignee Address" },
  { key: "ConsigneeSiteId", label: "Consignee Site ID" },
  { key: "FromPostOffice", label: "From Post Office" },
  { key: "FromDistrict", label: "From District" },
  { key: "FromTaluk", label: "From Taluk" },
  { key: "FromFullAddress", label: "From Full Address" },
  { key: "ToPostOffice", label: "To Post Office" },
  { key: "ToDistrict", label: "To District" },
  { key: "ToTaluk", label: "To Taluk" },
  { key: "ToFullAddress", label: "To Full Address" },
...
const Invoices = () => {
  ...
  const buildExportRow = (inv, attemptMeta = null) => {
    const baseRow = {
      ...
      FromDistrict: inv.fromAddress?.district || "",
      FromTaluk: inv.fromAddress?.taluk || "",
      FromFullAddress: inv.fromFullAddress || "",
      ToPostOffice: inv.toAddress?.postOfficeName || "",
      ToDistrict: inv.toAddress?.district || "",
      ToTaluk: inv.toAddress?.taluk || "",
      ToFullAddress: inv.toFullAddress || "",
