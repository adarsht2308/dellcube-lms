...
const CreateDriver = () => {
  ...
  const [createDriver, { isLoading, isSuccess, isError, data, error }] =
    useCreateDriverMutation(); // You must define this mutation
  ...
  const handleSubmit = async () => {
    const { name, mobile, password, licenseNumber, experienceYears, company, branch } = formData;
    if (!name || !mobile || !password || !licenseNumber || !experienceYears || !company || !branch) {
