...
const AllInvoices = () => {
  ...
  const { data, isLoading, refetch } = useGetDriverInvoicesQuery({
    driverId,
    page: currentPage,
    limit,
                        ...
                        <Select
                          ...
                          onValueChange={async (value) => {
                            try {
                              ...
                              await refetch(); // Use refetch directly
                            } catch (err) {
                        ...
                        <Button
                          ...
                          onClick={() =>
                            navigate("/admin/update-invoices", {
                              state: { 
                                invoiceId: invoice._id,
                                previousPage: "/admin/driver-invoices"
                              },
                            })
                          }
                        >
                  ...
                  <tr>
                    ...
                    >
                      ...
                      <p className="text-sm text-gray-400">
                        Assigned invoices will appear here
                      </p>
                    </td>
                  </tr>
                )}
        ...
        <div className="border-t border-gray-200 px-4 py-3 flex flex-col lg:flex-row lg:items-center lg:justify-between">
          <div className="mb-4 lg:mb-0">
            <p className="text-sm text-gray-700 dark:text-white">
              Showing{" "}
              {data?.invoices?.length ? (data?.page - 1) * data?.limit + 1 : 0}{" "}
